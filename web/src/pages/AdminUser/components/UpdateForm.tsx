...
import { AdminUser, AdminUserUpdateRequest } from '@/services/adminUser';

export interface UpdateFormProps {
  modalVisible: boolean;
  onCancel: () => void;
  onSubmit: (values: AdminUserUpdateRequest) => Promise<void>;
  values: AdminUser;
}
  ...
  return (
    <ModalForm
      ...
      onFinish={async (value) => {
        await onSubmit(value as AdminUserUpdateRequest);
      }}
    >
      <ProFormText
        name="username"
