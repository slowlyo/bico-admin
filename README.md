...
> - 🔐 **权限系统**：[docs/PERMISSIONS.md](docs/PERMISSIONS.md)
...
- **[权限系统](docs/PERMISSIONS.md)** - 基于代码定义的权限管理系统详解
- **[RBAC系统](docs/RBAC_SYSTEM.md)** - 角色权限访问控制系统设计
...
- **[权限系统](docs/PERMISSIONS.md)** - 权限代码定义和权限验证机制
...
- 🎨 **优雅前端** - 基于UmiJS + Ant Design Pro的现代化React管理界面
...
### 前端
- **框架**: [UmiJS](https://umijs.org/) - 企业级React应用框架
- **UI库**: [Ant Design Pro](https://pro.ant.design/) - 企业级UI设计语言
- **状态管理**: 内置状态管理 + Model
- **路由**: UmiJS路由系统
- **构建工具**: UmiJS内置构建工具
...
│   ├── go.sum
│   └── .env.example
├── frontend/               # 后台管理前端（遵循UmiJS标准目录结构）
│   ├── public/            # 静态资源
│   ├── src/               # 源代码（具体结构遵循UmiJS规范）
│   ├── package.json
│   ├── .umirc.ts         # UmiJS配置文件
│   └── tsconfig.json
├── docs/                  # 项目文档 📚 AI开发者必读
...
- **frontend/** - 后台管理界面，基于UmiJS + Ant Design Pro框架
- 遵循UmiJS标准目录结构，便于开发和维护
...
- 🔐 [认证增强](./docs/AUTH_IMPROVEMENTS.md) - 认证逻辑完善和安全功能说明
- 🔑 [权限系统](./docs/PERMISSIONS.md) - 基于代码定义的权限管理系统
- 👥 [RBAC系统](./docs/RBAC_SYSTEM.md) - 角色权限访问控制系统
...
- [UmiJS](https://umijs.org/) - 企业级React应用框架
- [Ant Design Pro](https://pro.ant.design/) - 企业级UI设计语言
